...
// src/components/landing/AliciaTeaser.tsx
import { ArrowRight as ArrowRight3, Sparkles } from "lucide-react";
import { jsx as jsx4, jsxs as jsxs3 } from "react/jsx-runtime";
function AliciaTeaser() {
  return /* @__PURE__ */ jsx4("section", { className: "bg-white px-4 py-16 dark:bg-slate-900", children: /* @__PURE__ */ jsx4("div", { className: "mx-auto w-full max-w-5xl", children: /* @__PURE__ */ jsxs3(
    "a",
    {
      href: "/alicia",
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs3("div", { className: "relative flex-1", children: [
          /* @__PURE__ */ jsxs3("span", { className: "inline-flex items-center gap-1.5 rounded-full border border-[#f4bcd0]/50 bg-white/10 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.22em] text-[#f4bcd0]", children: [
            /* @__PURE__ */ jsx4(Sparkles, { size: 12 }),
            " Novedad \xB7 AlicIA"
          ] }),
          /* @__PURE__ */ jsx4(
            "h2",
            {
              ...
              style: { fontFamily: "'Exo Soft','Exo 2',sans-serif" },
              children: "Inteligencia artificial para log\xEDstica internacional, dentro de SP Suite."
            }
          ),
          /* @__PURE__ */ jsx4("p", { className: "mt-3 max-w-2xl text-sm leading-relaxed text-white/80 md:text-base", children: "Redacta, traduce, resume, consulta y predice sin salir del expediente. AlicIA es el copiloto de Solport, incluido en SP Suite." })
        ] }),
        /* @__PURE__ */ jsx4("div", { className: "relative shrink-0", children: /* @__PURE__ */ jsxs3("span", { className: "inline-flex items-center gap-2 rounded-full border border-white/25 bg-white/10 px-5 py-2.5 text-sm font-bold text-white backdrop-blur-sm transition-all group-hover:bg-white/20", children: [
          "Descubrir AlicIA",
          /* @__PURE__ */ jsx4(ArrowRight3, { size: 16, className: "transition-transform group-hover:translate-x-0.5" })
        ] }) })
      ]
    }
  ) }) });
